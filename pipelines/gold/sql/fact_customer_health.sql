CREATE OR REPLACE TABLE gold.fact_customer_health AS
WITH
customers AS (
  SELECT DISTINCT customer_key, MAX((order_ts_raw AT TIME ZONE 'UTC') AT TIME ZONE 'America/New_York') AS last_order_date
...
--tested manually inside the duckdb notebook